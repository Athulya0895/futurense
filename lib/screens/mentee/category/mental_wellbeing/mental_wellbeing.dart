...
//search all mentors
  Widget _allmentorWidgetList() {
      ...
      child: SizedBox(
        ...
        child: GridView.builder(
            ...
            itemCount: provider.filterList.isEmpty &&
                ...
                ? provider.topMentalWellbeing.length
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ProfileImage(
                              url: provider
                                  .topMentalWellbeing[index].profilePic),
                          //                   const SizedBox(
                          //                     height: 20,
                          //                   ),
                          provider.isSelectedfilter == false ||
                          ...
                          provider.isSelectedfilter == false ||
                              ...
                              ? Text(
                                  provider
                                      .topMentalWellbeing[index].designationName
                                      .toString(),
                                  textAlign: TextAlign.center,
                                  style:const TextStyle(
    ...
    //                     children: [
    //                       ProfileImage(
    //                         url:  provider.topMentalWellbeing[index].profilePic),
    //                       //                   const SizedBox(
    //                       //                     height: 20,
    //                       //                   ),
    //                       provider.isSelectedfilter == false ||
